...
// use image_utils::save_as_png;
// mod image_utils;


fn render_sphere_orthographic() {
    let sphere = primitives::Sphere::new(Vector3::new(0., 0., 0.), 1.);
    let mut camera =
        primitives::Camera::new(Vector3::new(-1., 1., 1.), Vector3::new(-1., 1., 1.), 100);
    let light = primitives::Light::new(Vector3::new(0., 0., 1.));
    ...
    // save_as_png(camera, "sphere_orthographic.png");
}
